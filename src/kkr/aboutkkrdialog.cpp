...
AboutKKRDialog::AboutKKRDialog(PolledSettings *ps, QWidget *parent) : m_ps(ps), QDialog(parent) {
    ...
    QLabel *indonesianLabel = new QLabel(R"(
...
<p>Versi: 1.2<br>Dibuat oleh: Noer Holis K<br>Hak Cipta © 2025 Noer C. Semua hak dilindungi.</p>
...
<p>Terima kasih telah menggunakan Auto KK! Jika ada saran atau bug, hubungi<br>Email: ayah.syahid@gmail.com</p>
    ...
    QLabel *englishLabel = new QLabel(R"(
<h2>About Auto KK</h2>
...
<p>Developed using:</p>
<ul>
    <li>Qt 5.15.16: Cross-platform UI framework. License: GNU Lesser General Public License (LGPL) for open-source edition. See details: <a href="https://www.qt.io/licensing/">https://www.qt.io/licensing/</a></li>
...
<p>Version: 1.0<br>Created by: Noer Holis K<br>Copyright © 2025 Noer C. All rights reserved.</p>
